...
/* It seems to have version restrictions, please upgrade carefully */
	e('<script src="https://unpkg.byted-static.com/xgplayer/2.31.0/browser/index.js" type="text/javascript"></script>
	<script src="https://unpkg.byted-static.com/xgplayer-flv/2.3.29/browser/index.js" charset="utf-8"></script>
	<script>
	...
	e('<link href="https://lib.baomitu.com/video.js/7.20.1/alt/video-js-cdn.min.css" rel="stylesheet" />
	<video
		id="my-video",
		class="video-js"
  ...
  <script src="https://lib.baomitu.com/video.js/7.20.1/alt/video.core.min.js"></script>
		');
}
...
// This is an experimental feature, recommended only for videos with small capacity
    ...
    <script src="https://lib.baomitu.com/mux.js/5.14.1/mux.min.js"></script>
    <script>
